                    ...
                    <form action="{{ route('expedientes.update', $expediente) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="asunto" class="block mt-1 w-full" type="text" name="asunto"
                                :value="old('asunto') ?? $expediente->asunto" required autofocus autocomplete="username" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="fecha_inicio" class="block mt-1 w-full" type="date" name="fecha_inicio"
                                :value="old('fecha_inicio') ??
                                    \Carbon\Carbon::parse($expediente->fecha_inicio)->format('Y-m-d')" required autocomplete="username" />
